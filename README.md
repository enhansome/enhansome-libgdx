...
>
> This list is a curated collection of awesome resources, tools, tutorials, and projects using the [libGDX](https://libgdx.com/) game framework to help developers make *awesome* games, conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 501,407 | 🐛 105 | 📅 2026-08-21.
>
...
* [gdx-liftoff](https://github.com/tommyettinger/gdx-liftoff) ⭐ 684 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-30 - A modern setup tool for libGDX that supports more backends and allows adding libraries with one click.
...
* [TextraTypist](https://github.com/tommyettinger/textratypist) ⭐ 135 | 🐛 8 | 🌐 Java | 📅 2026-08-29 - Like TypingLabel (below), but also supports styles, emoji, multiple fonts, clickable links, etc.
...
* [gdx-jnigen](https://github.com/libgdx/gdx-jnigen) ⭐ 87 | 🐛 13 | 🌐 Java | 📅 2026-08-18 - Small library that allows C/C++ code to be written inline with Java source code.
...
* [Book of Shaders](https://github.com/patriciogonzalezvivo/thebookofshaders) ⭐ 6,994 | 🐛 68 | 🌐 GLSL | 📅 2026-02-28 - Step-by-step guide through the abstract and complex universe of Fragment Shaders. GLSL.
...
* [Java](https://github.com/akullpp/awesome-java) ⭐ 48,897 | 🐛 4 | 📅 2026-08-24 - A curated list of awesome Java frameworks, libraries and software.
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,220 | 🐛 14 | 🌐 Markdown | 📅 2026-08-29 - A list of Game Development resources to make magic happen.
* [Kotlin](https://github.com/KotlinBy/awesome-kotlin) ⭐ 11,379 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-28 - A curated list of awesome Kotlin related stuff.
