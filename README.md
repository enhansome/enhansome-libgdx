...
>
> This list is a curated collection of awesome resources, tools, tutorials, and projects using the [libGDX](https://libgdx.com/) game framework to help developers make *awesome* games, conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 504,510 | 🐛 106 | 📅 2026-09-02.
>
...
* [gdx-ai](https://github.com/libgdx/gdx-ai) ⭐ 1,302 | 🐛 33 | 🌐 Java | 📅 2024-10-01 - Artificial Intelligence framework featuring Steering Behaviors, Formation Motion, Pathfinding, Behavior Trees and Finite State Machines.
...
* [HyperLap2D](https://github.com/rednblackgames/HyperLap2D) ⭐ 442 | 🐛 11 | 🌐 Java | 📅 2026-08-24 - Visual editor for complex 2D worlds and scenes with a runtime for libGDX.
...
* [Ashley](https://github.com/libgdx/ashley) ⭐ 929 | 🐛 20 | 🌐 Java | 📅 2023-06-26 - A Java entity system inspired by Ash & Artemis.
* [Artemis-odb](https://github.com/junkdog/artemis-odb) ⭐ 831 | 🐛 41 | 🌐 Java | 📅 2023-04-14 - High performance java based Entity-Component-System framework.
...
* [steamworks4j](https://github.com/code-disaster/steamworks4j) ⭐ 548 | 🐛 34 | 🌐 Java | 📅 2026-05-06 - A thin wrapper which allows Java applications to access the Steamworks C++ API.
...
* [Packr](https://github.com/libGDX/packr) ⭐ 2,623 | 🐛 31 | 🌐 C++ | 📅 2024-04-11 - Packages your JAR, assets and a JVM for distribution on Windows, Linux and macOS.
* [gdx-liftoff](https://github.com/tommyettinger/gdx-liftoff) ⭐ 683 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-09 - A modern setup tool for libGDX that supports more backends and allows adding libraries with one click.
...
* [TextraTypist](https://github.com/tommyettinger/textratypist) ⭐ 135 | 🐛 7 | 🌐 Java | 📅 2026-09-09 - Like TypingLabel (below), but also supports styles, emoji, multiple fonts, clickable links, etc.
...
* [gdx-miniaudio](https://github.com/rednblackgames/gdx-miniaudio) ⭐ 77 | 🐛 3 | 🌐 C | 📅 2026-09-03 - Advanced Cross Platform Audio Engine for libGDX based on MiniAudio.
...
* [KTX](https://github.com/libktx/ktx) ⭐ 1,466 | 🐛 12 | 🌐 Kotlin | 📅 2025-06-28 - Kotlin extensions and utilities for libGDX.
...
* [gdx-jnigen](https://github.com/libgdx/gdx-jnigen) ⭐ 87 | 🐛 16 | 🌐 Java | 📅 2026-08-18 - Small library that allows C/C++ code to be written inline with Java source code.
...
* [Book of Shaders](https://github.com/patriciogonzalezvivo/thebookofshaders) ⭐ 7,007 | 🐛 68 | 🌐 GLSL | 📅 2026-02-28 - Step-by-step guide through the abstract and complex universe of Fragment Shaders. GLSL.
...
* [Java](https://github.com/akullpp/awesome-java) ⭐ 48,965 | 🐛 9 | 📅 2026-08-24 - A curated list of awesome Java frameworks, libraries and software.
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,269 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - A list of Game Development resources to make magic happen.
* [Kotlin](https://github.com/KotlinBy/awesome-kotlin) ⭐ 11,380 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-04 - A curated list of awesome Kotlin related stuff.
* [Game Networking](https://github.com/MFatihMAR/Awesome-Game-Networking) ⭐ 8,682 | 🐛 3 | 🌐 C | 📅 2026-08-27 - A Curated List of Game Network Programming Resources.
